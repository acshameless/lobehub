export default {
  ...
  'goalProcess.lifecycle.action.created.decision': 'requested a decision',
  'goalProcess.lifecycle.action.created.finding': 'drew a finding',
  'goalProcess.lifecycle.action.created.problem': 'raised a question',
  'goalProcess.lifecycle.action.linked': 'linked',
  'goalProcess.lifecycle.action.rejected': 'rejected {{kind}}',
  'goalProcess.lifecycle.action.resolved': 'completed {{kind}}',
  'goalProcess.lifecycle.action.resolved.decision': 'made a decision',
  'goalProcess.lifecycle.action.resolved.problem': 'answered a question',
  'goalProcess.lifecycle.action.retired': 'retired {{kind}}',
  'goalProcess.lifecycle.action.unlinked': 'unlinked',
  'goalProcess.lifecycle.action.updated': 'updated {{kind}}',
  'goalProcess.lifecycle.kind.decision': 'decision',
  'goalProcess.lifecycle.kind.experiment': 'experiment',
  'goalProcess.lifecycle.kind.finding': 'finding',
  'goalProcess.lifecycle.kind.goal': 'goal',
  'goalProcess.lifecycle.kind.problem': 'question',
  'goalProcess.lifecycle.kind.task': 'task',
